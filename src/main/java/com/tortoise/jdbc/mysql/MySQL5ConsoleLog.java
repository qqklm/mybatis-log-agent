 ...
 */
public class MySQL5ConsoleLog implements ClassFileTransformer, DefaultTransform {
    @Override
    public String agent() {
    ...
    public byte[] transform(ClassLoader loader, String className, Class<?> classBeingRedefined, ProtectionDomain protectionDomain, byte[] classfileBuffer) throws IllegalClassFormatException {
        return defaultTransform(className, "com.mysql.jdbc.PreparedStatement", classfileBuffer);
    }
}
